...
function save_asignacion(){
	datos=$("#form_asignacion").serialize();
	$.ajax({
		type: "POST",
		url: base_url+"index.php/Solicitud_almacen/save_asignacion",
		data: datos,
		success: function (result){
			 swal({
                            title: 'Exito!',
                            ...
                            if (isConfirm) {
                                window.location = base_url+"index.php/Solicitud_almacen/asignacion";
                            }
                        });
		}
	});
