        ...
        <div class="card">
            <div class="card-body">
                <div class="card-block">
                    <form class="form" id="form-unidades" method="post" autocomplete="off">
                    ...
                    <div class="row">
                                <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" id="economico" name="economico" class="form-control form-control-sm toupper" <?php if(isset($unidades)){ echo "value='$unidades->economico'";} ?>>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                             <select id="tipo_vehiculo" name="tipo_vehiculo" class="form-control form-control-sm ">
                                                  <option value="0" disabled="" selected="">Seleccione</option>
                                                  <?php foreach ($vehiculos as $item){ ?>
                                                    <option value="<?php echo $item->id?>" <?php if ( $unidades->tipo_vehiculo == $item->id) { echo 'selected';} ?> ><?php echo $item->nombre ?></option>
                                                  <?php } ?>
                                             </select>
                                        </div>
                                    </div>
                    ...
                    <h4 class="form-section"><i class="ft-file-text"></i> Circulación </h4>
                    ...
                    <div class="row">
                          <div class="col-4">
                             ...
                             <div class="col-4">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                           <input type="date" id="exp_circulacion" name="exp_circulacion" class="form-control form-control-sm toupper" <?php if(isset($unidades)){ echo "value='$unidades->exp_circulacion'";} ?> >
                                        </div>
                                    </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-4">
                                    <div class="form-group row">
                                        <div class="col-sm-4">
                                            <p>No. Fisico mecánica</p>
                                        </div>
                                        <div class="col-sm-8">
                                            <input type="text" id="fisicomecanica2" name="fisicomecanica2"  class="form-control form-control-sm toupper" <?php if(isset($unidades)){ echo "value='$unidades->fisicomecanica2'";} ?> >
                                        </div>
                                    </div>
                            </div>
     ...
     $(document).ready(function () {
        ...
        $("#form-unidades")
                .on('success.form.fv', function (e) {
                    ...
                    // Servicio
                    var primera3 = new Date('"'+$('#fecha_actual').val()+'"'); //01 de Octubre del 2013
                    var segunda3 = new Date('"'+$('#servicio_proximo').val()+'"'); //03 de Octubre del 2013
                    // Verificacion
                    var primera4 = new Date('"'+$('#exp_verificacion').val()+'"'); //01 de Octubre del 2013
                    var segunda4 = new Date('"'+$('#verificacion_proxima').val()+'"'); //03 de Octubre del 2013

                    if (primera > segunda) 
                    {
                        toastr.error("La fecha expedición de la Fisico Mecánica es mayor a la fecha vencimiento.");
                    } 
                    else if(primera2 > segunda2)
                    {
                        toastr.error("La fecha expedición de la póliza es mayor a la fecha vencimiento de poliza de seguro.");
                    } 
                    else if(primera3 > segunda3)
                    {
                        toastr.error("La fecha de servicio actual es mayor a la fecha del próximo servicio.");
                    }
                    else if(primera4 > segunda4)
                    {
                        toastr.error("La fecha de verificación es mayor a la fecha de la próxima verificación.");
                    }
                    else{
                    $.ajax({
                        type: "POST",
                        ...
                        if(data.success)
                        {
                         toastr.error("Ya existe una unidad con datos similares con este número de serie y número de motor. Ingrese datos diferentes. ");
                         }else{ 
                            if (data.respuesta > 0)
                            {
                ...
                .formValidation({
                    ...
                    fields: {
                        economico: {
                            validators: {
                                notEmpty: {
                                    message: "Por favor ingrese un número económico"
                                }
                            }
                        },
                        porcentaje: {
                        ...
                        tipo_vehiculo: {
                            validators: {
                                notEmpty: {
                                    message: "Por favor ingrese un tipo de Vehículo"
                                }
                            }
                        }
                    }
