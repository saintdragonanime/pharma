                    ...
                    <form class="form" id="form_cliente" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 row">
                                    ...
                                    <div class="col-8 controls">
                                        <input  onchange="verificaClienteExistente()" type="text" id="rfc" name="rfc" class="form-control form-control-sm toupper" <?php if(isset($cliente)){ echo "value='$cliente->rfc'";} ?> >
                                    </div>
                            </div>
                        ...
                        <div class="row">
                                <div class="form-group col-md-6 row">
                                        ...
                                        <div class="col-8 controls">
                                            <input type="text" name="no_cuenta" id="no_cuenta" class="form-control form-control-sm toupper" <?php if(isset($cliente)){ echo "value='$cliente->no_cuenta'";} ?> >
                                        </div>
                                </div>
                                 <div class="form-group col-md-6 row">
                                        <p class="col-4">Banco </p>
                                        <div class="col-8 controls">
                                            <input type="text" name="banco" id="banco" class="form-control form-control-sm toupper" <?php if(isset($cliente)){ echo "value='$cliente->banco'";} ?> >
                                        </div>
                                </div>
                            </div>
                        ...
                        <div id="personas">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    ...
                                    {
                                    ?>
                                    <button type="button" onclick="agregar_contacto()" class="mt-2 mb-0 round btn classBotonFratsa white addButton"><i class="fa fa-plus"></i></button>
                                    <?php }?>
                                </div>
                            </div>
                            ...
                            <h4 class="form-section"><i class="ft-plus-square"></i> Complementos de pago</h4>
                                ...
                                <div class="col-md-12 row">
                                    ...
                                    <div class="col-2 controls">
                                        ...
                                        {
                                        ?>
                                        <button type="button" class=" pull-right btn shadow-z-1 white classBotonFratsa" onclick="agregar_complemento()">
                        ...
                        <div class="col-md-12 text-center" id="div_unidades_dedicadas1" name="div_unidades_dedicadas1" style="display: none;">                    
                            <h4 class="form-section"><i class="fa fa-truck"></i> Económicos dedicados</h4>
                                <div class="col-md-12 row">
                                    <p class="col-5"></p>
                                    <div class="col-2 controls">
                                        <button type="button" class=" pull-right btn shadow-z-1 white classBotonFratsa" onclick="agregar_unidad()">
                                ...
                                <div class="content " >
                                    ...
                                    <div id="Unidad1" name="Unidad1" class="border_unidades">
                                        ...
                                        <div class="col-md-12 row">
                                            ...
                                            -->
                                            <select id="unidad[]" name="unidad[]" class="col-2 form-control form-control-sm chosen-select" data-placeholder="Seleccionar">
                                                <option></option>
                                            <?php foreach($unidades as $unidad) 
                                            { 
                                            ?>
                                                <option value="<?php echo $unidad->id;?>" >
                                                    <?php echo $unidad->economico,' ',$unidad->nombre ;?>
                                                    <!--bcdiv($unidad->economico,1)," ",-->
                                                </option>
                                            <?php 
                                            } 
                                            ?>
                        ...
                        <br><hr>
                        <div class="row">
                            <a href="<?php echo base_url(); ?>index.php/clientes" class="btn btn-icon btn-secondary" style="background-color: gray;"><i class="ft-chevron-left"></i> Regresar</a>
                            <?php if($visualizar!=1){ ?>
                            <button id="botonGuardar" type="submit" class="btn shadow-z-1 btnFratsa classBotonFratsa white" style="width: 50%; margin-left: 15%;">Guardar <i class="fa fa-save" ></i></button>
                            <?php }?>
                        </div>
...
<script>
    $(document).ready(function () 
    {
        ...
        table = $('#tabla_unidades_dedicadas').DataTable({
            "ajax":{ 
                "url": "<?php echo base_url();?>index.php/clientes/getUnidadesDedicadas/<?php echo $idCliente; ?>",
            },
            "columns": [
              {"data": "id"},
              {"data": "unidad"},
        ...
        table2 = $('#tabla_complementos_pago').DataTable({
            "ajax":{ "url": "<?php echo base_url();?>index.php/clientes/getComplementosPago/<?php echo $idCliente; ?>",
            },
            "columns": [
              {"data": "id"},
              ...
              {"data": "inicio_porcentaje",
                    render:function(data,type,row){
                        var html=row.inicio_porcentaje;
                        var res = html.split("-");
        ...
        table3 = $('#tabla_contactos_cliente').DataTable({
                "ajax":{ "url": "<?php echo base_url();?>index.php/clientes/getListadoContactosCliente/<?php echo $idCliente; ?>",
            },
            "columns": [
 ...
 $('#tabla_complementos_pago').on('click', '.eliminarComplemento_Pago', function(){
                        ...
                        success: function (data) {
                            if (data==1)
                            {
                                ...
                                <?php if(isset($cliente)){ // Si es Edicion
                                    ...
                                    echo "url='".base_url()."index.php/clientes';";
                                } ?>
    ...
    function agregar_contacto()
    {
        ...
        var $template = $('#div_persona_contacto1'),
                            ...
                            .append('<div class="row">\
                                <div class="col-md-12">\
                                    <button type="button" onclick="eliminar_contacto($(this))" class="btn btn-sm classBotonFratsa white pull-right" ><i class="fa fa-minus"></i></button>\
                                </div>\
                            </div>')
    ...
    function agregar_complemento()
    {
        ...
        var $template = $('#Complemento1'),
                            ...
                            .append('<div class="row">\
                                <div class="col-md-12">\
                                    <button type="button" onclick="eliminar_complemento($(this))" class="btn btn-sm classBotonFratsa white pull-right"><i class="fa fa-minus"></i></button>\
                                </div>\
                            </div>')
                            $clone.find("input").val("");
    ...
    function verificaClienteExistente()
    {
        var altaEdicion = '<?php echo $title; ?>';
        if(altaEdicion=='Alta')
        {
            var urlConsulta = 'verificaClienteExistente/';
        }
        else
        {
        ...
        $.ajax(
        {
            ...
            success: function (response) 
            {
                ...
                {
                    alert('Ya existe un cliente con este RFC, registre uno diferente por favor');
