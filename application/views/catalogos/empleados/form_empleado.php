        ...
        <div class="card"> 
            <div class="card-body">
                <div class="card-block">
                    <form class="form " id="form-empleado" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6 row">
                                    ...
                                    <div class="col-8 controls">
                                        <input type="text" name="nombre" id="name" class="form-control form-control-sm" <?php if(isset($empleado)){ echo "value='$empleado->nombre'";} ?> >
                                    </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 row">
                                    ...
                                    <div class="col-8 controls">
                                        <input onchange="verificaEmpleadoExistente()" type="text" name="curp" id="curp" class="form-control form-control-sm toupper" <?php if(isset($empleado)){ echo "value='$empleado->curp'";} ?> >
                                    </div>
                            </div>
                        </div>
                        <div class="row">
...
<!-- Operador -->
                        ...
                        <div id="contenedor_div_detalle_laboral" name="contenedor_div_detalle_laboral" style="display: inline" >
                            
                            <div class="row">
                                <div class="form-group col-md-6 row">
                                        <p class="col-4">Tipo de Unidad <span class="required">*</span></p>
                                        <div class="col-8 controls">
                                            <select id="empleado_tipo_unidad" name="empleado_tipo_unidad" class="form-control form-control-sm chosen-select" onchange="validaFullSencillo()">
                                                <option></option>
                                                <option value="FULL" <?php if(isset($empleado)){ if ($empleado->empleado_tipo_unidad=='FULL') echo 'selected'; } ?> >FULL</option>
                                                <option value="SENCILLO" <?php if(isset($empleado)){ if ($empleado->empleado_tipo_unidad=='SENCILLO') echo 'selected'; } ?> >SENCILLO</option>
                                            </select>
                                        </div>
                                </div>
                            
                                <div class="form-group col-md-6 row" id="div_empleado_tipo_vehiculo">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 row">
                                        <p class="col-4">Sueldo base </p>
                                        <div class="col-8 controls">
                                            <input type="text" name="sueldo" id="sueldo" class="form-control form-control-sm toupper" <?php if(isset($empleado)){ echo "value='$empleado->sueldo'";} ?> >
                                        </div>
                                </div>
                                 <div class="form-group col-md-6 row">
                                        <p class="col-4">Comisión por viaje (%) </p>
                                        <div class="col-8 controls">
                                            <input type="text" name="porcentaje_comision" id="porcentaje_comision" class="form-control form-control-sm toupper" <?php if(isset($empleado)){ echo "value='$empleado->porcentaje_comision'";} ?> max="100" min="0">
                                        </div>
                                </div>
                            </div>
...
/*
    ...
    */
        ...
        if(no!='' && no!=0 && rfc!='' && rfc!=0 )
        {
            ...
            $.ajax(
            {
                ...
                success: function (response) 
                {
                    ...
                    {
                        alert('El No de Empleado y/o RFC ya se han registrado previamente en otro empleado, ingrese datos diferentes por favor');
                        $("#botonGuardar").attr("style", "visibility: hidden");
                    }
                    else 
                    {
    ...
    function validaFullSencillo()
    {
        if($("#empleado_tipo_unidad").val()=='FULL')
        {
            //alert('El vehículo es de tipo Full, por lo que deberá guardar datos para Dolly y Plataforma 2');
            $.alert({
                title: 'Alerta!',
                icon: 'fa fa-info',
                type: 'red',
                content: 'El vehículo es de tipo Full, por lo que deberá guardar datos para Dolly y Plataforma 2',
            });
            $("#valida_tipo_vehiculo").val(1);
            $('#empleado_tipo_vehiculo').val('').trigger('chosen:updated');
            $('#div_empleado_tipo_vehiculo').attr('style','display:none');
        }
        else
        {
            $('#div_empleado_tipo_vehiculo').attr('style','display: inherit');
        }
    }
