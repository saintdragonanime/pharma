<div class="main-content">
    <div class="content-wrapper">
        <section class="color-palette">
            <div class="row">
                <div class="col-sm-12">
                    <div class="content-header mb-3">Catálogo de Subclientes</div>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="card-block">
                        <h5><i class="ft-file-text"></i> Listado de Subclientes</h5><hr>
                        <a href="<?php echo base_url(); ?>index.php/subclientes/alta" class=" pull-right btn shadow-z-1 white classBotonFratsa"><i class="ft-user-plus "></i> Agregar Subcliente </a><br><br>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h5>¿Está seguro de suspender a este Subcliente?</h5>
                ...
                <div class="modal fade text-left" data-keyboard="false" id="activacion" tabindex="-1" role="dialog" aria-labelledby="myModalLabel10" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <h5>¿Está seguro de activar este Subcliente?</h5>
                                <input type="hidden" id="idCliente" name="idCliente">
...
<script type="text/javascript" src="<?php echo base_url(); ?>public/js/listado_subclientes.js"></script> 
