                    ...
                    <form class="form" id="form_proveedor" method="post">
                            ...
                            <div class="form-group col-md-6 row">
                                    ...
                                    <div class="col-8 controls">
                                        ...
                                        <select id="tipo_proveedor" name="tipo_proveedor" class="form-control form-control-sm chosen-select">
                                            ...
                                            { 
                                            ?>
                                                <option value="<?php echo $tipo_proveedor->id;?>" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 row">
                                    ...
                                    <div class="col-8 controls">
                                        <input type="text" pattern="^\d+$" maxlength="5" name="cp" class="form-control form-control-sm toupper" <?php if(isset($proveedores)){ echo "value='$proveedores->cp'";} ?> >
                                    </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div  class="border" name="div_persona_contacto1" <?php if($i==0){ ?>id="div_persona_contacto1" <?php } ?>>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 row">
                                            ...
                                            <div class="col-8 controls">
                                                <input type="text" pattern="^\d+$" maxlength="20" id="telefono2[]" name="telefono2[]" class="form-control form-control-sm toupper"  <?php if(isset($contactos_proveedores[$i])){ echo "value='".$contactos_proveedores[$i]->telefono2."'";} ?>>
                                            </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6 row">
                                            ...
                                            <div class="col-8 controls">
                                                <input type="text" pattern="^\d+$" id="no_cuenta[]" name="no_cuenta[]" class="form-control form-control-sm toupper"  <?php if(isset($contactos_proveedores[$i])){ echo "value='".$contactos_proveedores[$i]->no_cuenta."'";} ?>>
                                            </div>
                                    </div>
                                    <div class="form-group col-md-6 row">
                                ...
                                <div class="row">
                                     <div class="col-md-12 text-center div_btn">
                                         <?php if($i==0){ ?>
                                        <button type="button" class="mt-2 mb-0 round btn btn-info addButton"><i class="fa fa-plus"></i></button>
                                        <?php } else { ?>
        ...
        $("#form_proveedor")
                        ...
                        success: function (data) {
                            if (data>0)
                            {
                                ...
                                <?php if(isset($proveedores)){ // Si es Edicion
                                    ...
                                    echo "url='".base_url()."index.php/Proveedores/edicion_proveedores/".$proveedores->id."';";
                                } ?>
                ...
                .on('click', '.addButton', function () {
                    var $template = $("#div_persona_contacto1"),
                        ...
                        .show()
                        .removeAttr('id')
                        .insertAfter($("#div_persona_contacto1"));
                    ...
                    $('form_proveedor').formValidation('addField', $clone.find('[name="tipo_contacto[]"]'));
                    $('form_proveedor').formValidation('addField', $clone.find('[name="condicion_pago[]"]'));
                    $('form_').formValidation('addField', $clone.find('[name="persona_contacto[]"]'));
                    $('form_proveedor').formValidation('addField', $clone.find('[name="telefono1[]"]'));
                    $('form_proveedor').formValidation('addField', $clone.find('[name="correo1[]"]'));
                })
