            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-block">
                        ...
                        <a href="<?php echo base_url(); ?>index.php/proveedores/alta" class=" pull-right btn btn-danger shadow-z-1 white classBotonFratsa"><i class="ft-user-plus"></i> Agregar Proveedor </a><br><br>
              ...
              <div class="modal-header">
                <h4 class="modal-title">¡Atención!</h4>
                  ...
                  <div class="col-md-12">
                           ...
                           <div class="conteiner">
                            <p class="col">¿Desea suspender la proveedor?</p>
                         ...
                         <br>
                             <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-default btn-secondary" data-dismiss="modal">Cerrar</button>
                             </div>         
                            </form>
                     </div>   
       </div>
